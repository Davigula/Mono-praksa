...
//    {
//        private const string CONNECTION_STRING = "Host=localhost:5432;" + "Username=postgres;" + "Password=1234;" + "Database=postgres";
//        private const string TABLE_NAME = "\"WeatherForecasts\"";
...
//        {
//            string commandText = $"UPDATE {TABLE_NAME} SET temperaturec = @tempC, summary = @summ WHERE id=@id";
//            using (var connection = new NpgsqlConnection(CONNECTION_STRING))
//            {
//                using var command = new NpgsqlCommand(commandText, connection);
//                connection.Open();
